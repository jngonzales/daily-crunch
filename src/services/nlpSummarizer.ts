// Browser-compatible NLP Summarizer using fallback methods only
export class NLPSummarizer {
  ...
  static async initialize(): Promise<void> {
    ...
    // Browser-compatible initialization - just set the flag
    this.isInitialized = true;
    console.log('NLP Summarizer initialized with fallback methods (browser-compatible)');
  }

  static async summarizeToPoints(content: string): Promise<string[]> {
    // Always use fallback method for browser compatibility
